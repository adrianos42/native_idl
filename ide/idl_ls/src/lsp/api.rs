...
impl LanguageServer for Server {
    ...
    async fn formatting(&self, params: DocumentFormattingParams) -> Result<Option<Vec<TextEdit>>> {
        let result =
            crate::core::formatting::format_document(self.session.clone(), params).await;
        Ok(result)
    }
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        Ok(crate::core::completion::completion(self.session.clone(), params).await)
    }
    ...
    async fn document_symbol(
        ...
        let result =
            crate::core::symbol::get_document_symbol(self.session.clone(), params).await;
        Ok(result)
    }
}
